...
<f:view>
	...
	<h:form styleClass="form-horizontal well">		
		...
		<h:panelGrid columns="2">
			<h:commandButton alt="#{htmlAltBundle['commandButton.unit2']}" action="#{organizationalStructureBackingBean.createSubUnit}" value="#{bundle['link.new.unit2']}" styleClass="btn btn-info"/>				
